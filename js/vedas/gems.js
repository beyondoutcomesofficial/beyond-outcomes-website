// Gems of the Vedas — the curated gallery. NOT comprehensive coverage:
// a hand-picked set of hymns that still stop the breath, each with honest context.
// status: 'live' | 'coming-soon'. gem.html?g=<id> loads js/vedas/<id>.js (window.VEDA_GEM_<ID>).
